...
const StatusSection: React.FC<StatusSectionProps> = ({ farms, title }) => {
  return (
    <Box>
      ...
      <Box bg="#222222" borderBottom="1px solid #E6C066" p={6} pr="14" borderRadius="md" color="white" fontFamily="monospace" w="100%">
        <Grid templateColumns={{ base: '1fr', md: 'repeat(4, 1fr)' }} gap={6} w="100%">
